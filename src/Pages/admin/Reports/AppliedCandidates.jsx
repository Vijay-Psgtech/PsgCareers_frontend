...
const AppliedCandidates = () => {
    ...
    const filterData = () => {
     ...
     const handleExport = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'AppliedCandidates');
        XLSX.writeFile(wb, 'Applied_Candidates_Report.xlsx');
    };

    return (
        <div className="p-6 bg-white rounded-xl shadow">
            <h2 className="text-2xl font-semibold mb-4">Applied Candidates Report</h2>
